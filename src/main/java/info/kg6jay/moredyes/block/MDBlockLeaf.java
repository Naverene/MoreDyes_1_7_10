                            ...
                            for (j2 = -range; j2 <= range; ++j2)
                            {
                                for (int k2 = -range; k2 <= range; ++k2)
                                {
                                    if (this.field_150128_a[(i2 + k1) * j1 + (j2 + k1) * b1 + k2 + k1] == xOffset - 1)
                                    {
                                        ...
                                        {
                                            this.field_150128_a[(i2 + k1 - 1) * j1 + (j2 + k1) * b1 + k2 + k1] = xOffset;
                                        }
                                        ...
                                        {
                                            this.field_150128_a[(i2 + k1) * j1 + (j2 + k1 - 1) * b1 + k2 + k1] = xOffset;
                                        }
                                        ...
                                        {
                                            this.field_150128_a[(i2 + k1) * j1 + (j2 + k1) * b1 + (k2 + k1 - 1)] = xOffset;
                                        }
