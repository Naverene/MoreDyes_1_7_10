...
public class MDEntitySheep extends EntitySheep {
    ...
    public static final float[][] fleeceColorTable = new float[][] { { 1.0F, 1.0F, 1.0F }, { 0.85F, 0.5F, 0.2F },
        ...
        { 0.95F, 0.5F, 0.65F }, { 0.3F, 0.3F, 0.3F }, { 0.6F, 0.6F, 0.6F }, { 0.3F, 0.5F, 0.6F }, { 0.5F, 0.25F, 0.7F },
        { 0.2F, 0.3F, 0.7F }, { 0.4F, 0.3F, 0.2F }, { 0.4F, 0.5F, 0.2F }, { 0.6F, 0.2F, 0.2F }, { 0.1F, 0.1F, 0.1F } };
    /**
    ...
    private int func_90014_a(EntityAnimal sheep1, EntityAnimal sheep2) {
        ...
        this.crafting.getStackInSlot(0)
            .setItemDamage(i);
        this.crafting.getStackInSlot(1)
            .setItemDamage(j);
        ItemStack itemstack = CraftingManager.getInstance()
            .findMatchingRecipe(this.crafting, ((MDEntitySheep) sheep1).worldObj);
        int k;
