...
public class ChiselCompat {
    ...
    public static void registerChisel() {
        if (ConfigHandler.chisel_support) {
            ...
            ICarvingGroup[] groups = new ICarvingGroup[] { new CarvingGroup("blockWool", "wool"),
                new CarvingGroup("stone", "stone"), new CarvingGroup("cobblestone", "cobblestone"),
                new CarvingGroup("blockObsidian", "obsidian"), new CarvingGroup("bricksStone", "stoneBrick"),
                new CarvingGroup("bricksStoneCarved", "stoneBrickCarved"),
                new CarvingGroup("bricksStoneCracked", "stoneBrickCracked"), new CarvingGroup("soul_sand", "soul_sand"),
                new CarvingGroup("blockQuartz", "quartz"), new CarvingGroup("blockCoal", "blockCoal"),
                new CarvingGroup("blockRedstone", "blockRedstone"), new CarvingGroup("plankWood", "plankWood"),
                new CarvingGroup("glowstone", "glowstone"), new CarvingGroup("lapisBlock", "lapisBlock"),
            ...
            for (int i = 0; i < MDBlock.wool.length; i++) {
                ...
                if (ConfigHandler.chisel_plank) groups[11].addVariation(new Variation(MDBlock.plank[i]));
